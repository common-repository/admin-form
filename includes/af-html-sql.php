 ...
 */
 ...
 class  ADFO_html_sql {
    ...
    static function render_sql_from($table_model, $show_editor = false ) {
        ...
        ?><div id="dbp_content_query_edit" class="af-content-query-edit <?php echo esc_attr($class_toggle); ?>"><?php
    ...
    static private function render_html_btns() {
        ...
        <div class="dbp-result-query-btns js-result-query-btns">
            <?php 
            $btns['edit_inline'] = 
            '<div id="dbp-bnt-edit-query" class="button dbp-btn-show-sql-view" onclick="show_sql_query_edit()">'. __('Edit inline','admin_form').'</div>';
      
            $btns['cancel'] =
            '<div id="dbp-bnt-cancel-query"  class="button dbp-btn-show-sql-edit"  onclick="hide_sql_query_edit()">'. __('Cancel','admin_form').'</div>';
       
            $btns['organize'] =
            '<div id="dbp-bnt-columns-query" class="button js-show-only-select-query dbp-btn-disabled js-btn-disabled"  onclick="af_columns_sql_query_edit()">'. __('Organize columns','admin_form').'</div>';

            $btns['merge'] =
            '<div id="dbp-bnt-merge-query" class="button js-show-only-select-query dbp-btn-disabled js-btn-disabled"  onclick="af_merge_sql_query_edit()">'. __('Merge','admin_form').'</div>';

            $btns['metadata'] =
            '<div id="dbp-bnt-metadata-query" class="button js-show-only-select-query js-show-only-metada-query dbp-btn-disabled js-btn-disabled"  onclick="af_metadata_sql_query_edit()">'. __('Add meta data','admin_form').'</div>';
