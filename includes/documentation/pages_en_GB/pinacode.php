...
<p> You can otherwise execute the template engine instructions via the <b> adfo_tmpl </b> shortcode. Add a shortcode block from the editor and type:
...
function register_my_post_type() {
    ...
    <p>Create a link to an administrative list. You can pass additional parameters to filter past data</p>
        ...
        <p>Example: In a list it shows the data of another filtered list and the button to go to edit the data. <br>
                ...
                4. On the new form open List view formatting and click add row at the bottom<br>
        </p>
...
[%nu.c] | [%unser.d]</pre>
  ...
  <h3>is_*</h3>
    ...
    <h3>[^GET_SINGLE id=""]</h3>
    <p>Prints the results of a single record.</p>

    <h3>[^GET_DETAIL dpb_id="" id=""]</h3>
    <p>Extracts data from a specific record</p>
...
:]]</pre>
    ...
    <p>Create the button to download a list.</p>
...
<div class="dbp-help-p">
    ...
    <div class="dbp-help-p">
        <h3>val</h3>
        <p>In the results extracted from a list, the unmodified value is returned. For example in a select field where the values are replaced by label it returns the value or in a media library field it returns the id of the image.</p>
...
[%a count] [%a singular="Item" plural="Items"]</pre>
    ...
    <h3>json</h3>
    <div class="dbp-help-p">
        <p>Converts a string formatted as a json to an array</p>
        <pre class="dbp-code">[%my_json_var json tmpl[:&lt;p&gt;[%key]=[%item.title]&lt;/p&gt;:]]]</pre>
    </div>

    <h3>unserialize</h3>
    <div class="dbp-help-p">
        <p>Converts a string formatted as a php serialize to an array</p>
    ...
    <h3 class="dbp-h3">Attributes for numbers</h3>
    <div class="dbp-help-p">
        <h3>set+=  set-=</h3>
        <div class="dbp-help-p">
...
1.203,2</div>
    ...
    <div class="dbp-help-p">
        ...
        <div class="dbp-help-p">
            <p>Time fields are saved in seconds in the database. This attribute transforms seconds into time format hh:mm.</p>
        </div>

        <h3>timestr-to-timenum</h3>
        <div class="dbp-help-p">
            <p>Time fields are saved in seconds in the database. This attribute transforms the value from the format time hh:mm into seconds. </p>
        </div>

        <h3>time-to-hour</h3>
        <div class="dbp-help-p">
            <p>This attribute calculates the number of hours from a time field, ie in seconds, or from a time value in the format hh:mm. </p>
        </div>
