...
<h2 class="dbp-h2"> <a href="<?php echo admin_url("admin.php?page=admin_form_docs") ?>">Doc</a><span class="dashicons dashicons-arrow-right-alt2"></span><?php _e('LIST FORM js script','admin_form'); ?></h2>
    ...
    <ul>
        <li><b>field.val(val)</b> // val optional if set it sets the variable. If is a date or time timestamp is used</li>
    ...
    <p>Set a default date. I use the timestamp in seconds.</p>
    <pre class="dbp-code">
        if (status == 'start') {
