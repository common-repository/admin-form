...
<div class="af-content-margin">
    <div id="dbp_help_list_of_records" class="dbp_help_div">
        Each list can be viewed in the frontend through a shortcode, or called from php code. You can in fact call the filter<a class="js-simple-link" href="<?php echo admin_url("admin.php?page=admin_form_docs&section=hooks") ?>" target="_blank">adfo_frontend_get_list</a> to redesign its content.<br>
        There are two types of views that you can generate, either a table or you can draw your own view through the <a class="js-simple-link" href="<?php echo admin_url("admin.php?page=admin_form_docs&section=pinacode") ?>" target="_blank">integrated template engine</a>.
    </div>
