...
<div class="af-content-margin">
       ...
       <p> The view of the ADMIN FORM plugin is meant to be modified only by the site administrators, if you want to allow other users to manage the contents of a list, go to the "settings" tab and activate the "Show in admin" options menu ". <br> This creates a shortcut in the administrative menu for the specified list </p>
</div>
