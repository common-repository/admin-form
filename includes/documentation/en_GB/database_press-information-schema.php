...
<div class="af-content-margin">
    <p> Show all Admin Form. Wordpress tables have a prefix that identifies them. Not all tables can be modified, this depends on their state. </p>
    ...
    <a class="js-simple-link" href="<?php echo admin_url("admin.php?page=admin_form_docs&section=hooks") ?>" target="_blank">Learn more: Hooks & filters</a>
</div>