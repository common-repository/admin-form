...
<div class="af-content-table dbp-docs-content  js-id-dbp-content" >
    ...
    <hr>
    <h2 class="dbp-h2"> apply_filters('<b>adfo_frontend_build_custom_link</b>', $custom_link, $list_id, $primary_values, $col_value, $col_key);</h2>
    ...
    <div class="dbp-help-p">
        ...
        <pre class="dbp-code">
        /**
        * Nella tabella del frontend:  Nell'HTML dove è stato messo lo shortcode [adfo_list id=xx] inserisco un html personalizzato '<div id="dbp_div_target_link"></div>'
        */
    ...
    <hr>
    <h2 class="dbp-h2">apply_filters('<b>adfo_frontend_table_thead</b>', header_text, $list_id, $array_thead); </h2>
    ...
    <hr>
    <h2 class="dbp-h2">apply_filters('<b>adfo_save_data</b>', $query_to_execute, $list_id, $origin)</h2>
    ...
    */
    ...
    add_filter('adfo_save_data', 'dbp_action_in_save_data', 10, 3);
        </pre>
    </div>
...
add_filter('adfo_frontend_get_list', 'my_custom_list', 10, 2);</pre>
    ...
    <h2 class="dbp-h2">apply_filters( '<b>adfo_items_add_action</b>, $btns, $dbp_id, $count_unique_id);</h2>
    ...
    <h4 class="dbp-h4">Example</h4>
    <div class="dbp-help-p">
        <pre class="dbp-code">add_action( 'adfo_items_add_action', 'fn_adfo_items_add_action', 10, 3 );
function fn_adfo_items_add_action($btns, $dbp_id, $count_unique_id) {
    ...
    <h2 class="dbp-h2">do_action( '<b>adfo_partial_list_add_tabs</b>');</h2>
    Viene chiamato dopo che sono disegnati tutti i tab.
    <hr>
   
    <h4  class="dbp-h4">Source</h4>
    <div class="dbp-help-p">.admin/partials/af-partial-tabs.php</div>
    
    <h4 class="dbp-h4">Example</h4>
    <div class="dbp-help-p">
        <pre class="dbp-code">add_action( 'adfo_partial_list_add_tabs', function() { 
    ...
    Viene chiamato dal controller che definisce cosa disegnare nella pagina.
    Lo si può associare al filtro 'adfo_list_admin_controller_show_list_all'
    <hr>
    <h4 class="dbp-h4">Parameters</h4>
    <div class="dbp-help-p">
        <ul>
    ...
    Viene chiamato dal controller che definisce cosa disegnare nella pagina.
    Serve per inibile la visualizzazione della pagina all-list
    <hr>
    <h4 class="dbp-h4">Parameters</h4>
    <div class="dbp-help-p">
        <ul>
