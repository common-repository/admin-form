...
<h2 class="dbp-h2"> <a href="<?php echo admin_url("admin.php?page=admin_form_docs") ?>">Doc</a><span class="dashicons dashicons-arrow-right-alt2"></span><?php _e('LIST FORM js script','admin_form'); ?></h2>
    ...
    <ul>
        <li><b>field.val(val)</b> // val opzionale se impostato setta la variabile. Le date e il time viene sempre convertito in timestamp.</li>
        ...
        <li><b>field.name();</b> // return field name</li>
    </ul>
    ...
    <p>Imposta una data di default. Uso il timestamp in secondi.</p>
    <pre class="dbp-code">
        if (status == 'start') {
            field.val(1583677568);
        }
    </pre>
