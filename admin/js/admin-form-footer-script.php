            ...
            <div class="dbp-vote-popup-background" id="dbp_vote_popup">
                <div class="dbp-vote-popup">
                    <div class="dbp_vote_popup_content">
                        <h2>If you like ADMIN FORM, please take a minute to rate the plugin.</h2>
                    ...
                    <div class="dbp-vote-grid">
                        ...
                        <div class="dbp-vote-cell " onclick="dbp_vote_plugin('already_vote')"><a href="https://wordpress.org/support/plugin/admin-form/reviews/?filter=5#rate-response" target="_blank" class="dbp-submit" style="color:#FFF">I'm going to vote</a></div>
                    </div>
                </div>
            </div>
            <?php
...
<script>
    ...
    document.getElementById('wpbody-content').style.height = document.getElementById('adminmenu').offsetHeight+"px";
</script>